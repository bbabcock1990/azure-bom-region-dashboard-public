...
_FIELDS = (
    ...
    "refresh_subscription",        # (legacy) subscription used to refresh datasets from Azure
    "context_subscription",        # global default subscription context (drives refresh, validation, new BOMs)
)
